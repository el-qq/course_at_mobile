...
public class WaitHelper {
    ...
    static void waitForElementNotPresent(AppiumDriver appiumDriver, By elementBy) {
    ...
    static void waitForElementPresent(AppiumDriver appiumDriver, By elementBy) {
        waitForElementPresent(appiumDriver, elementBy, elementBy.toString(), BASE_TIMEOUT);
    }

    static WebElement waitAndGetElement(AppiumDriver appiumDriver, By elementBy) {
